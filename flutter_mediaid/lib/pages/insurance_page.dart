...
import 'package:flutter_mediaid/functions/insurance.dart';


class InsurancePage extends StatefulWidget {
  const InsurancePage({Key? key, required this.title}) : super(key: key);
  ...
  Widget build(BuildContext context){
    return Container(
      child: FutureBuilder<List>(
              future: insuranceService.getAllInsurance(),
